    ...
    return (
        <div className="container pl-5 pr-5">
            <article className="card mb-3">
                ...
                <div className="card text-light" style={{marginLeft:2.5+'em'}}>
                    ...
                    <div className="card-img-overlay">
                        ...
                        <p>An online judging platform made as both a Discord bot and a website.<br></br>
                        Hosted 9 contests, has over 60 problems, and supports 16 programming languages.
                        </p>
                ...
                <div className="card text-light" style={{marginLeft:2.5+'em',marginTop:2+'em'}}>
                ...
                <div className="card text-light" style={{marginLeft:2.5+'em', marginTop:2+'em', marginBottom:2+'em'}}>
